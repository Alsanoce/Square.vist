...
const STEPS = [
  { icon: "🛒", num: "١", title: "اختر الكمية",      desc: "حدد عدد كراتين الماء التي تريد التبرع بها — كل كرتونة بـ 7 دينار فقط" },
...
const FEATURES = [
  ...
  { icon: "💰", title: "سعر مناسب",     desc: "7 دينار فقط للكرتونة — ميسور لكل أحد" },
];
